...
{
    public class WorldContextSeedDate
    {
        private WorldContext _context;
        private UserManager<WorldUser> _userManager;

        public WorldContextSeedDate(WorldContext context,UserManager<WorldUser> userManager)
        {
            _context = context;
        ...
        public async Task EnsureSeedDataAsync()
        {
            if (await _userManager.FindByEmailAsync("sam.hastings@theworld.com") == null)
            {
              ...
              IdentityResult x=  await _userManager.CreateAsync(newUser,"P@ssw0rd");
            }
